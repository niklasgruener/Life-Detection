...
This repository contains the full codebase for my bachelor thesis **"[Multimodal Visual Life Detection using a Compact Tri-Modal Camera Unit](Bachelor%20thesis.pdf)"**, including detection pipelines, evaluation scrips and real-time integration for:
