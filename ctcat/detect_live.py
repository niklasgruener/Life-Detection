...
def run_detection(modality):
    """Detect people using yolo model in the given modality."""
    ...
    while True:
        ...
        result = model.predict(source=raw, save=False, classes=0, device=0)[0]  
        ...
        cv2.imshow("Live YOLOv8 Predictions", colored)
